    ...
    >
      ...
      <div className="">
        ...
        >
          ...
          {/* message date */}
          <span className="absolute right-2 bottom-1.5 text-xs text-dark_text_5 leading-none">
            {moment(message.createdAt).format("HH:mm")}
          </span>
          {/* Traingle */}
          <span>
            {!me && <TraingleIcon className="dark:fill-dark_bg_2 rotate-[60deg] absolute top-[-5px] -left-1.5 " />}
          </span>
        </div>
      </div>
    </div>
